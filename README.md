...
|---|---|---|
| [**bayesian-credit-updating**](./bayesian-credit-updating) | Frames conditional credit pricing as Bayesian default updating: a spread-implied prior revised by signal likelihood ratios, with explicit handling of the correlation between signals (where naive independence overstates risk). Includes a hierarchical Bayesian model and an out-of-sample calibration backtest. | Python, PyMC, scikit-learn, LaTeX |
